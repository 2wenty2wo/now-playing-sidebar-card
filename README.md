...
- Icon packs like `si:` and `phu:` must be installed if used (`si:` (Simple Icons): <https://github.com/vigonotion/hass-simpleicons>, `phu:` (Phosphor): <https://github.com/elax46/custom-brand-icons>)
